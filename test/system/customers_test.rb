...
class CustomersTest < ApplicationSystemTestCase
  ...
  test "creating a Customer" do
    ...
    fill_in "Email of the company contact", with: @customer.email_of_the_company_contact
    fill_in "Full name of service technical authority", with: @customer.full_name_of_service_technical_authority
    fill_in "Full name of the company contact", with: @customer.full_name_of_the_company_contact
